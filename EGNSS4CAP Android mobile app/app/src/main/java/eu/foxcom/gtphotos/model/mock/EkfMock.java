    ...
    private void writeEkf(EkfData ekfData, int latId, int lngId, int altId, int refT, int comT) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                latTextView.setText(ekfData.getLatitude() == null ? "null" : Util.createLatLngDecimalFormat().format(ekfData.getLatitude()));
                TextView lngTextView = findViewById(lngId);
                lngTextView.setText(ekfData.getLongitude() == null ? "null" : Util.createLatLngDecimalFormat().format(ekfData.getLongitude()));
                TextView altTextView = findViewById(altId);
                altTextView.setText(ekfData.getAltitude() == null ? "null" : Util.createLatLngDecimalFormat().format(ekfData.getAltitude()));
