...
import eu.foxcom.stp.gsa.egnss4cap.SettingFilterActivity;
import eu.foxcom.stp.gsa.egnss4cap.SettingsActivity;
...
public class PersistData {
    ...
    public enum PREFERENCES {
        ...
        CAPTURE_POINT_PERIOD("CAPTURE_POINT_PERIOD");
    ...
    public static int getSamplingNumber(Context context) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        return sharedPreferences.getInt(PREFERENCES.SAMPLING_NUMBER.ID, SettingsActivity.SAMPLING_NUMBER_DEFAULT);
    }
    ...
    public static int getCapturePointPeriod(Context context) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        return sharedPreferences.getInt(PREFERENCES.CAPTURE_POINT_PERIOD.ID, SettingsActivity.CAPTURE_POINT_PERIOD_DEFAULT);
    }

    public static void saveCapturePointPeriod(Context context, int period) {
        SharedPreferences.Editor editor = getEditor(context);
        editor.putInt(PREFERENCES.CAPTURE_POINT_PERIOD.ID, period);
        editor.apply();
    }
}
