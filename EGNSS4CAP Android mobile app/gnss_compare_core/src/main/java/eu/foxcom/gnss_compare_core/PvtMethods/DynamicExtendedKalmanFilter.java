...
//        SimpleMatrix sigma2C1 = new SimpleMatrix(CONSTELLATION_SIZE, 1);
        ...
        if(usedInCalculations > 0) {
            ...
            Coordinates coordinates = Coordinates.globalXYZInstance(x_meas.get(idxX), x_meas.get(idxY), x_meas.get(idxZ));
    ...
    public static void registerClass(){
        register(NAME, eu.foxcom.gnss_compare_core.PvtMethods.DynamicExtendedKalmanFilter.class);
    }
