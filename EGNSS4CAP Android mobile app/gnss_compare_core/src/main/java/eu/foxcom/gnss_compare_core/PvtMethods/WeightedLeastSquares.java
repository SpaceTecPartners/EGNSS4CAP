...
public class WeightedLeastSquares extends eu.foxcom.gnss_compare_core.PvtMethods.PvtMethod {
...
//        rxPosSimpleVector.print();
        ...
        pose.setRefTime(new Time(DateTime.now().toDate().getTime()));
    ...
    public static void registerClass(){
        register(NAME, eu.foxcom.gnss_compare_core.PvtMethods.WeightedLeastSquares.class);
    }
}
