var lavorazioniCtrl = function ($scope, $ionicLoading, $stateParams, $state, $q, sessionService, appService, $filter, sqliteService, $rootScope, gpsDiagnosticService) {
  ...
  $scope.$on('$ionicView.afterEnter', function() {
    ...
    document.getElementById("space_manufact").innerHTML = device.manufacturer;
    document.getElementById("space_model").innerHTML = device.model;
...
lavorazioniCtrl.$inject = ['$scope', '$ionicLoading', '$stateParams', '$state', '$q', 'sessionService', 'appService', '$filter', 'sqliteService', '$rootScope', 'gpsDiagnosticService'];
angular.module('lavorazioni.module').controller('lavorazioniCtrl', lavorazioniCtrl);
