...
##Demo##
- plnkr:http://plnkr.co/edit/Dinswg?p=preview (using ionicons)
- plnkr:http://plnkr.co/edit/rCpPfK?p=preview  (using font-awesome)
...
##### code available in folder ```bgColor-floatingButtonDemo```
