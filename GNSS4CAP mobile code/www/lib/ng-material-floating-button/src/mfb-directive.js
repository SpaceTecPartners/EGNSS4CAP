;(function(window, angular, undefined) {
  ...
  mfb.run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put('ng-mfb-buttonorange-default.tpl.html',
      '<li>' +
      '  <a data-mfb-label="{{label}}" class="mfb-component__buttonorange">' +
      '    <i class="mfb-component__child-icon {{icon}}">' +
      '    </i>' +
      '  </a>' +
      '</li>'
  ...
  mfb.directive('mfbButtonOrange', [function() {
    return {
      require: '^mfbMenu',
      restrict: 'EA',
      transclude: true,
      ...
      templateUrl: function(elem, attrs) {
        return attrs.templateUrl || 'ng-mfb-buttonorange-default.tpl.html';
      }
    };
  }]);
